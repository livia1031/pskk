            ...
            <div class="container-fluid">
                ...
                <form action="/home/save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="int" class="form-control" id="mtk" placeholder="Matematika" name="mtk">
                    </div>
                    <div class="form-group">
                        <label for="bing">Bahasa Inggris</label>
                        <input type="int" class="form-control" id="bing" placeholder="Bahasa Inggris" name="bing">
                    </div>
                    <div class="form-group">
